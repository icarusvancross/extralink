...
export default function AdsterraPage({ step, totalSteps, onNext }: any) {
  ...
  return (
    <div onClick={() => { if(!hasStarted) { setHasStarted(true); window.open(SMARTLINK, '_blank'); } }} className="min-h-screen bg-slate-50 flex flex-col items-center relative font-sans overflow-x-hidden cursor-pointer pb-40">
      <Script src="https://pl28859100.effectivegatecpm.com/fe/4c/47/fe4c47fb58ff46e2395b8f4a2ec3ceac.js" strategy="afterInteractive" />
      <Script src="https://pl28859246.effectivegatecpm.com/d5/32/ef/d532efcecc92896fd5072b4cf8dbbac3.js" strategy="afterInteractive" />
      ...
      {/* إعلان Native علوي عبر Iframe */}
      <div className="w-full max-w-md mt-6 px-4">
        <iframe src="/ads/adsterra-native.html" className="w-full h-[180px] border-0 overflow-hidden rounded-3xl shadow-lg"></iframe>
      </div>
      ...
      <div className="max-w-md w-full px-8 mt-20 space-y-20 text-center">
        {/* بانر Adsterra المربع عبر Iframe */}
        <div className="flex flex-col items-center py-10">
          <p className="text-slate-300 text-[7px] font-black uppercase mb-4 tracking-[0.5em]">Sponsored Content</p>
          <iframe src="/ads/adsterra-banner.html" className="w-[320px] h-[270px] border-0 overflow-hidden rounded-3xl shadow-2xl"></iframe>
        </div>
